...
# this represents the latest kubernetes version that kops' master branch should support
# bump this when new kops release branches are created
kops_master_k8s_version = "1.20"
...
def should_skip_newer_k8s(k8s_version, kops_version):
    if kops_version is None:
        return float(k8s_version) > float(kops_master_k8s_version)
